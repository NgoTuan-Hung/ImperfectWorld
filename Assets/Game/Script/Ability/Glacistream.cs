...
public class Glacistream : SkillBase
{
    ...
    public override void RecalculateStat()
    {
        ...
        GetActionField<ActionFloatField>(ActionFieldName.Damage).value =
            customMono.stat.wisdom.FinalValue * 10f;
        damageOverTime = GetActionField<ActionFloatField>(ActionFieldName.Damage).value / 10f;
    }
    ...
    )
    {
        ...
        GetActionField<ActionGameEffectField>(ActionFieldName.GameEffect).value =
            GameManager.Instance.glacistreamEffectPool.PickOneGameEffect();
        ...
        GetActionField<ActionGameEffectField>(ActionFieldName.GameEffect)
            .value.GetBehaviour<GlacistreamBehaviour>(EGameEffectBehaviour.GlacistreamBehaviour)
            .Setup(
                customMono,
                GetActionField<ActionFloatField>(ActionFieldName.Damage).value,
                damageOverTime
    ...
    {
        Trigger(location: p_doActionParamInfo.targetOriginPosition);
    }
}
