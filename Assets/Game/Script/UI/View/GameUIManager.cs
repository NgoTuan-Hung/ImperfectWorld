...
//     public Vector2 skillTreeSkillSize = new(80, 80),
//         skillTreeSkillOffset = new(150, 150),
//         skillTreeContainerSize = new(2912, 1632),
//         skillSlotSize = new(100, 100);
...
//     public bool CheckVisualElementTouchState(VisualElement visualElement) =>
//         VisualElementTouched[visualElement.GetHashCode()];

//     public void StopVisualElementTouchState(VisualElement visualElement) =>
//         VisualElementTouched[visualElement.GetHashCode()] = false;
...
//     public VisualTreeAsset usableScrollViewHolderVTA,
//         joystickVTA,
//         contentSkillItemVTA,
//         contentStatVTA,
//         charSelectionCharVTA;
...
//     {
//         usableScrollViewHolderVTA = Resources.Load<VisualTreeAsset>(
//             "MainView__UsableScrollViewHolder"
//         );
...
//     public void AddTooltipHandlerForVisualElement(
//         VisualElement p_visualElement,
//         VisualElement p_toolTip
//     )
//     {
//         p_visualElement.RegisterCallback<PointerDownEvent>(
//             (evt) =>
//             {
//                 if (evt.clickCount > 1)
//                 {
//                     p_toolTip.transform.position = p_toolTip.parent.WorldToLocal(
//                         new Vector2(
//                             evt.position.x + p_toolTip.resolvedStyle.width
//                             > root.resolvedStyle.width
//                                 ? evt.position.x - p_toolTip.resolvedStyle.width
//                                 : evt.position.x,
//                             evt.position.y + p_toolTip.resolvedStyle.height
...
//         );
//         root.Query<VisualElement>(classes: "safe-area")
//             .ForEach(
//                 (ve) =>
//                 {
